...
var fav_location = ["Netherlands", "Dubai", "Turkey", "Scotland", "Australia"];
console.log("The Original Array");
console.log(fav_location);
var sort_array = fav_location.slice().sort();
...
console.log(fav_location);
//reverse array
var reverse_array = sort_array.slice().reverse();
...
var language = ['English', 'French', 'German', 'Spanish', 'Persian'];
